...
return {
	...
	keys = {
		...
		{ "<leader>6", function() require("harpoon.ui").nav_file(6) end, desc = "Navigate to file 6", },
		{ "<leader>7", function() require("harpoon.ui").nav_file(7) end, desc = "Navigate to file 7", },
		{ "<leader>8", function() require("harpoon.ui").nav_file(8) end, desc = "Navigate to file 8", },
		{ "<leader>9", function() require("harpoon.ui").nav_file(9) end, desc = "Navigate to file 9", },
	},
	opts = {},
}
